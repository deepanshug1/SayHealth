...
public class CustomerMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Button mLogout,mRequest,mSettings,mHistory,mPayment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(CustomerMapActivity.this, "Ride Ended!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(CustomerMapActivity.this, payment.class);
